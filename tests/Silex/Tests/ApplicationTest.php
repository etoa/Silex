...
class ApplicationTest extends TestCase
{
    ...
    public function testOn()
    {
        ...
        $app->on(Event::class, function (Event $e) use ($app) {
            $app['pass'] = true;
        });

        $app['dispatcher']->dispatch(new Event());
    ...
    public function testMountNullException()
    {
        ...
        $this->expectErrorMessage('The "mount" method takes either a "ControllerCollection" instance, "ControllerProviderInterface" instance, or a callable.');
    ...
    {
        $this->expectException(\LogicException::class);
        $this->expectErrorMessage('The method "Silex\Tests\IncorrectControllerCollection::connect" must return a "ControllerCollection" instance. Got: "NULL"');
    ...
    {
        $this->expectException(\LogicException::class);
        $this->expectErrorMessage('The "homepage" route must have code to run when it matches.');
